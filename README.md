...
3. **Secondary Assembly/Rescue:** If no complete genome is generated by GetOrganelle, NOVOPlasty for extension of best scaffold produced by GetOrganelle (automatically inverted if orientation does not match the standard)
4. **Standardization:** Automated decision logic to rotate assemblies to a uniform starting position and select correct isomer (if isomers present)
...
* **`${sample_id}_cpDNA_raw.fasta`:** Raw, pre-polished assembly of genome as generated by GetOrganelle or NOVOPlasty
